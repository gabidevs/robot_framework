...
*** Keywords ***
Teste pegando data atual
    ${AGORA}    Get Current Date     result_format=%d-%m-%y    #y em minusculo extrai apenas os dois últimos dígitos do ano
...
Trabalhando com tempo
    ...
    ${HORA}     Convert Time	5400   verbose    #O argumento verbose irá passar informações de assim: 1 hour 30 minutes 
